...
class SurahDetailServices : ObservableObject{
    ...
    func getSurah(surahId : Int){
        ...
        guard let url = URL(string: "https://api.alquran.cloud/v1/surah/\(surahId)/ar.abdurrahmaansudais") else{
